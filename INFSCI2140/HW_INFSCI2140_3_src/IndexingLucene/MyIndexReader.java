...
public class MyIndexReader {
	...
	/**
	 * Return the number of times the token appears in the appointed document.
	 * added by YEC24@pitt.edu
	 * 
	 * @param token
	 * @param docid
	 * @return
	 * @throws IOException
	 */
	public int TokenFreq(String token, int docid) throws IOException {
		int freq = 0;
