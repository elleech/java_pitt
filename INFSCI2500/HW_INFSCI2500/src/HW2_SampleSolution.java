...
public class HW2_SampleSolution<E>{
    protected Object[] data;
    protected int size;

    public HW2_SampleSolution(int n) throws IllegalArgumentException{
        if(n<0){
    ...
    public static void main (String[] args){
		...
		HW2_SampleSolution<Integer> s = new HW2_SampleSolution<Integer>(5);
		s.append(1);
		s.append(2);
		s.append(3);
		s.append(4);
