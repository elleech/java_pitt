...
public class HW4_LinkedListPureQueue<E> implements PureQueue<E> {
    //The linkedlist will maintain size, front, and back references for us.
    protected LinkedList<E> list; 

    
    //Default constructor.
    public HW4_LinkedListPureQueue(){
        list = new LinkedList();    //an empty linked list.
    }
    
    //Copy constructor
    public HW4_LinkedListPureQueue(HW4_LinkedListPureQueue<E> otherQueue){
    ...
    public static void main(String[] args){
                HW4_LinkedListPureQueue<String> myQueue= new HW4_LinkedListPureQueue<String>();
